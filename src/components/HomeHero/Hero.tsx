...
const Hero = () => {
  return (
    <div className="grid grid-cols-1 bg-red-50 lg:grid-cols-2 ">
          ...
          <div className="flex flex-col justify-center items-center lg:items-start ">
            ...
            <p className='sm:text-lg text-center lg:text-left mb-6'>At StartSmart, we are more than just your coaches; we’re your dedicated partners in success. </p>
          </div>
        </div>
