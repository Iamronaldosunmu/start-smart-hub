	...
	return (
		<Link to={`/courses/${id}`}>
			<motion.div
				...
				className="overflow-hidden rounded-lg relative w-full max-w-[360px] h-[433px] grid grid-rows-[200px_auto] border-2 border-[#e5e7e8] hover:shadow-lg transition-shadow"
			>
				<img
				...
				<div className="p-4 h-full w-full">
					...
					<p className="text-sm mb-3 font-DMSans">{description.length < 228 ? description : `${description.slice(0, 228)}...`}</p>
