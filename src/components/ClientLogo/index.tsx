		...
		<div className="h-[175px] pt-8">
			...
			>
				<img
					...
					src="public/assets/client1.png"
					alt="logo 1"
				/>
				<img
					className="object-cover py-2 h-24 mr-10"
					src="public/assets/client2.png"
					alt="logo 2"
				/>
				<img
					className="object-fill py-2 h-24 mr-10"
					src="public/assets/client3.png"
					alt="logo 3"
				/>
				<img
					className="object-cover py-2 h-24 mr-10"
					src="public/assets/client4.png"
					alt="logo 4"
				/>
				<img
					className="object-cover py-2 h-24 mr-10"
					src="public/assets/client5.png"
					alt="logo 5"
				/>
				<img
					className="object-cover py-2 h-24 mr-10"
					src="public/assets/client6.png"
					alt="logo 6"
				/>
				<img
					className="object-cover py-2 h-24 mr-10"
