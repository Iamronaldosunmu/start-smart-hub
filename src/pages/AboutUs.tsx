    ...
    <>
      ...
      <div className="mt-10">
        <TextSection
          ...
          paragraphs={[
            " I’ve had the privilege of collaborating with numerous hiring managers, fellow recruiters, and helping over 50 diverse candidates secure jobs that have not only increased their income but also facilitated their transformative career transitions.",
          ]}
        />
        <TextSection
          heading="Our Mission"
          paragraphs={[
            "At StartSmart Hub, our mission is simple yet impactful: To help you “Start Smart and Build Bright”. We’re dedicated to providing you with the knowledge, resources and support you need to thrive in your new career, and we’re excited to embark on this journey with you.",
            "Welcome to StartSmart Hub, where your career success story begins!",
          ]}
        />
      </div>
      <Bookings />
