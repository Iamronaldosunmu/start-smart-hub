	...
	return (
		<section className="mt-14 lg:mt-[100px] font-poppins bg-[#FFF2EC] py-[67px] overflow-hidden">
			<Container className="flex flex-col items-center justify-center">
				<div className="text-2xl lg:text-[37px] text-[#262B2B] text-center font-bold lg:font-semibold font-poppins flex [&>*:not(:last-child)]:mr-3">
				...
				>
					<div className="flex justify-center items-center [&>*:not(:last-child)]:mr-20 pt-8 animate-scroll">
