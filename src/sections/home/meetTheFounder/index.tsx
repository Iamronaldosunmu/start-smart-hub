...
const MeetTheFounder = () => {
	return (
		<Container className="flex flex-col lg:flex-row items-center justify-center gap-x-[112px] mt-14 lg:mt-[100px]">
			<div className="relative w-[517px] h-[522px] hidden lg:block">
				<img
			...
			<div className="flex flex-col items-center gap-y-6 lg:max-w-[504px]">
				<h2 className="text-[44px] lg:text-[48px] text-[#331B3B] font-bold leading-[51px] tracking-tight lg:tracking-[-0.03em] self-start sm:self-center">
