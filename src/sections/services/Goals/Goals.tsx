		...
		<div className="py-10 px-5 md:py-28 bg-hero-pattern object-fit w-full text-white items-center mt-14 lg:mt-[100px]">
			<Container className="m">
				<div className="flex flex-col justify-center items-center">
					<TextAnimation
						text={"We’re dedicated to providing you with the knowledge and support you need to thrive in your new career"}
						className={"quotation-marked text-2xl md:text-3xl text-center lg:w-[750px] mb-5 font-semibold flex flex-wrap gap-x-2"}
					/>
					<p
						data-aos="zoom-in"
